...
class Sidebar(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        self.sidebar_btn2 = HoverButton(self, text="Bücher verwalten", bg="#232121", fg="white", relief="flat", font="Verdana", activebackground="#232121", borderwidth="0", activeforeground="#df4807",autostyle=False)
        self.sidebar_btn3 = HoverButton(self, text="Leihgaben", bg="#232121", fg="white", relief="flat", font="Verdana", activebackground="#232121", borderwidth="0", activeforeground="#df4807",autostyle=False)
        self.sidebar_btn4 = HoverButton(self, text="Anfragen", bg="#232121", fg="white", relief="flat", font="Verdana", activebackground="#232121", borderwidth="0", activeforeground="#df4807",autostyle=False)
        self.sidebar_btn5 = HoverButton(self, text="Mahnungen", bg="#232121", fg="white", relief="flat", font="Verdana", activebackground="#232121", borderwidth="0", activeforeground="#df4807",autostyle=False)
        ...
        # Logo einbinden
        self.logo_import = Image.open("logo.png").resize((200,65))
        self.logo_tk = ImageTk.PhotoImage(self.logo_import)
        
        self.logo_label = ttk.Label(self, image=self.logo_tk, background="#232121")
        self.logo_label.place(relx=0.1, rely=0.88)